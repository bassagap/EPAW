...
<div class="menu">
	<ul>
		<li><img src="img/miniLogo.png" alt="logo" style="width:45%"></li>
		<li><a href="#Login" style="margin-left:-100px">Login</a></li>
		<li><a href="#Register">Register</a></li>
		<li><a href="#AboutUs">About Us</a></li>
	</ul>
</div>

<div class="flecha" style="display: none;">	
	<a href="#top"><img width="76" height="110" src="img/flecha.png" alt="flecha" typeof="foaf:Image"></a>
</div>
	
<span class="goto" id="Login"></span>
<div class="singup" id="Login">
	<h1>Login</h1>
	<div class="field">
...
<span class="goto" id="Register"></span>
<div class="singup" id="Register">
	<h1>Register</h1>
	
	<form action="/Lab1_EPAW/FormController" method="post" id="registerForm">
		<!--===============USERNAME===================-->
		<div class="field">
...
<div class="singup">
	<img src="img/miniLogo.png" alt="logo" style="display: block; margin: 0 auto;">
	<p> 
